...
def aggregate_geotiff_period_mean(paths: list[str], adm2_gdf: gpd.GeoDataFrame, value_name: str) -> pd.DataFrame:
...
def aggregate_xarray_period_mean(da: xr.DataArray, adm2_gdf: gpd.GeoDataFrame, value_name: str) -> pd.DataFrame:
    region_ids = adm2_gdf["region_id"].tolist()
    records = []
